...
class NaiveSourcer:
    ...
    #         return lambda x: x.dt_published
    #     else:
    ...
    # def fetch_aggregated_articles_to_be_sourced(self, topic_id: str) -> List[RawArticle]:
    #     aggregated_articles_to_be_sourced = []
    #     # TODO
    #     return aggregated_articles_to_be_sourced
    ...
    #     )
    #     self.fetch_aggregator_runs_to_be_sourced(topic_id)
